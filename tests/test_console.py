...
class TestHBNBCommand_prompting(unittest.TestCase):
    ...
    def test_do_show(self, mock_stdout):
        """Test show command"""
        with patch('builtins.input', return_value='show BaseModel 45678') as f:
    ...
    def test_help_quit(self, mock_out):
        ...
        with patch("builtins.input", return_value="help quit") as f:
    ...
    def test_help_show(self, mock_outpt):
        ...
        with patch("builtins.input", return_value="help show") as f:
    ...
    def test_help_destroy(self, mock_output):
        """Test help destroy"""
        with patch('builtins.input', return_value="help destroy") as f:
    ...
    def test_help_all(self, mock_output):
        ...
        with patch('builtins.input', return_value="help all") as f:
    ...
    def test_do_update(self, mock_output):
        """Test update command"""
        with patch('builtins.input', return_value="help update") as f:
    ...
    def test_do_all(self, mock_stdout):
        """Test all command"""
        with patch('builtins.input', return_value='all BaseModel 45678') as f:
    ...
    def test_do_destroy(self, mock_stdout):
        ...
        with patch('builtins.input', return_value='destroy') as f:
